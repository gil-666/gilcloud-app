...
<div class="backdrop-blur-xl bg-upload fixed top-0 h-screen w-screen z-100">
  <div class="file-upload flex items-center justify-center w-full h-full">
    <i class="pi pi-times relative -top-40 left-150 cursor-pointer" @click="$emit('close')" style="font-size: 30px"></i>
    <label for="dropzone-file" class="flex flex-col items-center content-center justify-center w-150 h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-neutral-800 dark:hover:bg-green-950 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600" @dragover="onDragOver"
           @drop="onDrop">
      <div class="flex flex-col items-center justify-center pt-5 pb-6">
        ...
        <ProgressBar v-if="isFileSelected" class="mt-2 border-1 border-neutral-500 w-full" :show-value="true" :value="Number(props.progress)"></ProgressBar>
      </div>
